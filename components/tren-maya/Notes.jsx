      ...
      >
        <div className="max-w-3xl max-h-screen bg-white px-4 lg:px-8 py-6  overflow-y-auto">
          ...
          <div className="text-sm mb-6">
            <h3 className="text-sm font-bold mb-1">Pretrazo:</h3>
            <p className="text-xs">
          ...
          <div className="text-sm mb-6">
            <h3 className="text-sm font-bold mb-1">Estación Cancún Centro:</h3>
            <p className="text-xs">El proyecto de estación Cancún Centro corresponde a una fase posterior del Tren Maya.</p>
          </div>

          <div className="text-sm mb-6">
            <h3 className="text-sm font-bold mb-1">Accesibilidad:</h3>
            <p className="text-xs">La metodología de cálculo siguió a Pereira et al. (2019), que propone un método estandarizado para medir los niveles de accesibilidad. Para el cálculo de indicadores se tomaron las siguientes consideraciones:</p>
            <p className="text-xs">
          ...
          <div className="text-sm mb-6">
            <h3 className="text-sm font-bold mb-1">Destinos:</h3>
            <p className="text-xs">Los destinos evaluados fueron obtenidos del Directorio Estadístico Nacional de Unidades Económicas (DENUE) (INEGI, 2019).</p>
          </div>
          <div className="text-sm mb-6">
            <h3 className="text-sm font-bold mb-1">Ruteos:</h3>
            <p className="text-xs">Para el cálculo del tiempo de viaje utilizando transporte público se utilizó una cadena de viaje multimodal en la que para llegar a una estación se consideró el tiempo y velocidad a pie.</p>
            <p className="text-xs">Para viajes en transporte público, se estima la accesibilidad considerando que el usuario se desplaza a pie al llegar y al salir de la estación. Los tiempos de espera son determinados por las frecuencias aproximadas de cada ruta.</p>
            <p className="text-xs">Una descripción detallada de la configuración predeterminada de ruteo puede consultarse en OpenTripPlanner, 2021.</p>
          </div>
          <div className="text-sm mb-6">
            <h3 className="text-sm font-bold mb-1">Zona Metropolitana de Cancún:</h3>
            <p className="text-xs">La zona metropolitana considera los municipios de Benito Juárez e Isla Mujeres. (SEDATU, CONAPO e INEGI, 2018)</p>
          </div>
          <div className="text-sm mb-6">
            <h3 className="text-sm font-bold mb-1">Infraestructura existente:</h3>
            <p className="text-xs">Sistema de transporte público local de la ZMC: Para generar una red de transporte público útil para el análisis, se partió de la información disponible para la ZMC proveída por la DGTV de Cancún (2021). Debido a que no existe una red funcional disponible para este modo, se programó una aproximación de la cobertura de la red en un estándar abierto en el formato GTFS (General Transit Feed Specification), considerando la cobertura a nivel metropolitano. </p>
            <p className="text-xs">
